...
import { getSalesReturnById } from "../actions";
...
type SalesReturn = {
  ...
  refundMethod: string;
  description?: string;
  customer: { name: string; code: number; phone?: string };
...
export default function SalesReturnDetailsPage() {
  ...
  return (
    <>
      <Navbar title={`مرتجع مبيعات رقم ${data.returnNumber}`} />
      <div className="p-6" dir="rtl">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>{data.customer.name} (كود: {data.customer.code})</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p>{data.refundMethod === 'cash' ? 'نقدي' : data.refundMethod === 'safe' ? 'خزنة' : 'بنك'}</p>
                </div>
                {data.reason && (
        ...
        <div className="mt-6 flex gap-2 justify-end">
          ...
          <Button onClick={() => router.push(`/sales-returns/${id}/edit`)}>
